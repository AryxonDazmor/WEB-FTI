...
const DRIVE_API_URL = process.env.NEXT_PUBLIC_ANOTHER_DRIVE_API_URL as string;
  ...
  useEffect(() => {
    async function loadTree() {
      try {
        setLoading(true);
        setError(null);
        const res = await fetch(DRIVE_API_URL); // no ?subject= — single folder script
